...
url_from_api('biz7-rwwj')   #Miami Springs Police Department dataset identifier is 'biz7-rwwj'


#file created for the purpose of storing data; Miami Springs Police_crime_data.json stores crime data of Miami Springs Police
file = open("Miami Springs Police Dept_data.json","w")
